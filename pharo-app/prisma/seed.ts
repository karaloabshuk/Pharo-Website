...
async function main() {
  ...
  const playerData: { name: string; price: number; position: string; teamIndex: number }[] = [
    // GK
  ...
  // Note: 'Abel' appears twice in original data (MID and FWD), keep both as distinct players
  let playerCount = 0;
